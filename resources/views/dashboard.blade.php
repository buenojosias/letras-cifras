<x-app-layout>
    <x-ts-card header="Welcome to the TallStackUI Starter Kit">
        <div class="space-y-2">
            <p>
        ...
        <x-slot:footer>
            <span class="text-xs">
                ⚠️ <x-ts-link href="https://tallstackui.com/docs/v2/starter-kit" bold blank sm>Make sure to read the docs about the starter kit!</x-link>
            </span>
        </x-slot:footer>
    </x-ts-card>
</x-app-layout>
