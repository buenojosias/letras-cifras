<div>
    <x-ts-card>
        <x-ts-alert color="amber" icon="light-bulb">
        ...
        <x-ts-table :$headers :$sort :rows="$this->rows" paginate simple-pagination filter loading :quantity="[2, 5, 15, 25]">
            ...
            <div class="flex gap-1">
                <x-ts-button.circle icon="pencil" wire:click="$dispatch('load::user', { 'user' : '{{ $row->id }}'})" />
